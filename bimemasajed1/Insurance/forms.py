...
class Coverage_Form(forms.ModelForm):
    class Meta:
        ...
        labels={
            ...
            'mamooriat_khارج': 'ماموریت خارج از کارگاه',
            ...
            'mamooriat_khارج_person': 'حداکثر تعهد فردی (ماموریت خارج از کارگاه)',
            'mamooriat_khارج_total': 'حداکثر تعهد کل (ماموریت خارج از کارگاه)',
